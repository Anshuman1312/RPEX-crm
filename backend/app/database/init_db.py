...
DEFAULT_PERMISSIONS = {
    ...
    "manage_telecalling": "telecalling",
    "manage_sales_team": "sales_team",
    "access_partner_portal": "partner",
    "view_own_bookings_payments": "partner",
}
...
ROLE_PERMISSION_MAP = {
    ...
    "DIRECTOR": {"view_leads", "view_analytics", "export_reports", "manage_finance", "manage_sales", "manage_projects"},
    "PROJECT_HEAD": {"view_leads", "edit_leads", "manage_followups", "manage_customers", "manage_sales", "manage_projects"},
    "MARKETING_MANAGER": {"view_leads", "view_analytics", "manage_campaigns", "manage_keywords", "manage_projects", "manage_whatsapp", "manage_vendors"},
    "SALES_MANAGER": {"view_leads", "edit_leads", "manage_followups", "manage_sales", "manage_customers", "manage_projects", "manage_sales_team", "manage_whatsapp"},
    "SALES_EXECUTIVE": {"view_leads", "edit_leads", "manage_followups", "manage_sales"},
    "TELECALLER": {"view_leads", "edit_leads", "manage_followups", "manage_telecalling"},
    "CRM_EXECUTIVE": {"view_leads", "manage_customers", "manage_documents", "manage_projects", "manage_telecalling"},
    "FINANCE": {"manage_finance", "export_reports", "manage_vendors"},
    "LEGAL": {"manage_documents"},
    "HR": {"export_reports", "manage_hr"},
    "RECEPTIONIST": {"view_leads", "manage_customers"},
    "CHANNEL_PARTNER": {"access_partner_portal", "view_own_bookings_payments"},
    "DEVELOPER": {"manage_websites", "view_analytics"},
    "CUSTOMER_PORTAL": {"view_own_bookings_payments"},
}

DEFAULT_LEAD_STATUSES = ["NEW", "CONTACTED", "FOLLOW_UP", "INTERESTED", "SITE_VISIT", "NEGOTIATION", "BOOKING", "LOST", "FUTURE"]
